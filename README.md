...
All curated knowledge lives in `data/` and `docs/` and is loaded at request time —
**no code change needed** to update content.

| File                          | Purpose                                             |
|-------------------------------|-----------------------------------------------------|
| `docs/concept_writing_rules.md` | The rules injected into every prompt.             |
...
lib/
  knowledge.ts             loads + caches data/docs (server-only)
